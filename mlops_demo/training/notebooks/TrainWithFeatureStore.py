...
dbutils.widgets.text(
    "model_name", "dev.marcin_wojtyczka.mlops_demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.marcin_wojtyczka.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.marcin_wojtyczka.trip_dropoff_features",
