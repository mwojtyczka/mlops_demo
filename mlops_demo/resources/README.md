...
| prod        | The `prod` deployment target is part of the CD pipeline. Latest main content will be deployed to prod workspace with `prod` config.                                                                      | prod workspace       | prod-mlops_demo-model    | /prod-mlops_demo-experiment    |
...
When you about to cut a release, you can create and merge a PR to merge changes from main to main. Continuous deployment automation will deploy `prod` resources to the prod workspace.
